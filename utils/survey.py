...
class Survey:
    ...
    def __init__(self, browser):
        ...
        #'order_receptions': order_receptions,
        #'order_reception_weights': order_reception_weights,
        #'order_times': order_times,
        #'order_time_weights': order_time_weights,
        #'survey_chance': survey_chance,
        #'auto': auto,
        #'run_in_background': run_in_background,
        # 'surveys_per_hour': surveys_per_hour
    ...
    def run(self):
        ...
        try:
            ...
            reception, reception_suffix = self.selector.select_order_reception(self.order_receptions, self.order_reception_weights, selected_type)
