review_tree = {
    ...
    ('had a post-run meal', 'loved our time', 'had a post-hike meal', 'went for a casual meal', 'had a fantastic lunch',
     'decided to enjoy a family meal', 'spent our night', 'had a team lunch', 'went for a quick bite'): [
        "at Buffalo Wild Wings",
        "at BWW",
        "at B-Dubs",
        "at the local Buffalo Wild Wings",
    ...
    ('planned a celebration meal', 'decided to hang out', 'had a book discussion night', 'planned a study break meal',
     'planned a neighborhood outing', 'had a project celebration', 'planned a fantastic lunch',
